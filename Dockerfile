###############################################################################
# docker login && docker build -t gleam73/antd-neo-st . && docker push gleam73/antd-neo-st
###############################################################################
### 
### FROM node:18-alpine
...
### 
### COPY *.js .
### # Copies the dependencies in the package.json file for install app dependencies
